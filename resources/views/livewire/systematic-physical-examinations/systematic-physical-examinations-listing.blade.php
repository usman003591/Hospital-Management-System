            ...
            <div class="mb-5 form-group row bg-search">
                <div class="col-lg-4">
                    <input type="text" wire:model.live.debounce.500ms="q" id="q" name="q"
                           ...
                           placeholder="Search Systematic Physical Examination" value="" maxlength="50">
                </div>
                ...
                <div class="col-lg-3">
                    <select wire:model.live="parent_id" id="parent_id"
                        ...
                        @foreach($parentExaminations as $id => $name)
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-bordered table-row-dashed gy-4 fw-bold dataTable">
                            <thead class="text-gray-500 fs-7 text-uppercase">
                                <tr role="row" class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                    ...
                                    <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="3" rowspan="1" colspan="1"
                                        aria-label="Parent: Activate to sort" tabindex="0" style="min-width: 8rem"><span
                                            class="dt-column-title">Parent</span><span class="dt-column-order"></span></th>
                                    <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="3" rowspan="1" colspan="1"
                                    ...
                                    <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="3" rowspan="1" colspan="1"
                                        aria-label="Is Manual: Activate to sort" tabindex="0" style="min-width: 7rem"><span class="dt-column-title">Is Manual</span><span class="dt-column-order"></span></th>
                            ...
                            <tbody class="fs-6">
                                ...
                                @else
                                    <tr>
                                        <td colspan="6" class="text-center">No records found @if($q || $parent_id || $verification_status) for the applied filters @endif</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
                        <div class="row">
                            <div class="col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start dt-toolbar">
                                <div>
                                    ...
                                    @else
                                        No records found @if($q || $parent_id || $verification_status) for the applied filters @endif
                                    @endif
                                </div>
                            </div>
