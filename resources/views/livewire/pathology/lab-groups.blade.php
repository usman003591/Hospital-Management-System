            ...
            <div class="mb-5 form-group row bg-search">
                ...
                <div class="col-lg-6">
                    <input type="text" wire:model.live.debounce.500ms="q" id="q" name="invoice_search"
                        ...
                        placeholder="Search By Patient Name, MR Number, CINIC, Lab Group Number, Or Mobile Number" value="" maxlength="50">
                </div>
                ...
                <div class="col-lg-2">
                    <select id="status" wire:model.live="status"
                        class="ajax_call_trigger form-select form-select-solid bg-body-secondary" data-kt-select2="true"
