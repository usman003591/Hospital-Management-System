            ...
            <div class="mb-5 form-group row bg-search">
                <div class="col-lg-7">
                    <input type="text" wire:model.live.debounce.500ms="q" id="q" name="q"
                        ...
                        placeholder="Search Department" value="" maxlength="50">
                </div>
                        ...
                        <table class="table align-middle table-row-bordered table-row-dashed gy-4 fw-bold dataTable">
                            ...
                            <tr role="row" class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                <th class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom"
                                    data-dt-column="0" rowspan="1" colspan="1" aria-label="Department: Activate to sort"
                                    tabindex="0" style="min-width: 12rem"><span
                                        class="dt-column-title">Department</span><span class="dt-column-order"></span>
                                </th>
                                ...
                                <th class="min-w-90px dt-orderable-asc dt-orderable-desc" data-dt-column="2" rowspan="1"
                                ...
                                <th class="text-center min-w-50px dt-orderable-none" data-dt-column="3" rowspan="1"
                            ...
                            <tr class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                <td>
                                    <div class="d-flex flex-column justify-content-center">
                                        <a href="" class="mb-1 text-gray-800 text-hover-primary">{{ $d->name }}</a>
                                    </div>
                                </td>
                                <td data-order="{{ $d->created_at }}">{{ getBasicDateTimeFormat($d->created_at) }}</td>
                                <td>
                                    @if($d->status == 1)
