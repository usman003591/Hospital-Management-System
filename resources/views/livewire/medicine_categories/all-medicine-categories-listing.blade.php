<div class="container">
    <div class="row">
        <div class="col-md-12">
             ...
             <div class="mb-5 form-group row bg-search align-items-center">
                <div class="col-md-5">
                    <input type="text" wire:model.live.debounce.500ms="q" id="q" name="patient_search"
                        class="form-control form-control-solid bg-body-secondary"
                        placeholder="Search Medicine Category" maxlength="150">
                </div>
                        ...
                        <table class="table align-middle table-row-bordered table-row-dashed gy-4 fw-bold dataTable">
                            ...
                            <tr role="row" class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                               ...
                               <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="1" rowspan="1"
                                ...
                                <span class="dt-column-title">Medicine Categories</span><span class="dt-column-order"></span>
                               </th>

                                <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="1" rowspan="1"
                                    colspan="1" aria-label="Date: Activate to sort" tabindex="0"
                                    style="min-width: 150px">
                                    <span class="dt-column-title">Created at</span><span class="dt-column-order"></span>
                                </th>
