            ...
            <div class="mb-5 form-group row bg-search">
                <div class="col-lg-4">
                    <input type="text" wire:model.live.debounce.500ms="q" id="q" name="q"
                           ...
                           placeholder="Search Diagnosis" value="" maxlength="50">
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-bordered table-row-dashed gy-4 fw-bold dataTable">
                            <thead class="text-gray-500 fs-7 text-uppercase">
                                <tr role="row" class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                    ...
                                    <th class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom"
                                        ...
                                        tabindex="0" style="min-width:9rem"><span class="dt-column-title">Code</span><span
                            ...
                            <tbody class="fs-6">
                                @if (count($data) > 0)
                                    @foreach ($data as $d)
                                        <tr class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                            ...
                                            {{-- <td>
                                                @if($d->is_manual == 1)
                                                    <span class="mr-2 badge badge-success font-weight-lighter">Yes</span>
                                                @else
                                                    <span class="mr-2 badge badge-danger font-weight-lighter">No</span>
                                                @endif
                                            </td> --}}
                                            <td>
                                    @if($d->is_manual == 1)
                                ...
                                @else
                                    <tr>
                                        <td colspan="7" class="text-center">No records found @if($q || $status || $verification_status) for the applied filters @endif</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
                        <div class="row">
                            <div class="col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start dt-toolbar">
                                <div>
                                    ...
                                    @else
                                        No records found @if($q || $status || $verification_status) for the applied filters @endif
                                    @endif
                                </div>
                            </div>
