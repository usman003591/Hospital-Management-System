            ...
            <div class="mb-5 form-group row bg-search">
                ...
                <div class="col-lg-2 d-flex justify-content-end align-items-end">
                    <button type="button" wire:click="resetFilters" id="normal_reset"
                        class="px-6 btn btn-sm btn-primary me-2">
                        Reset
                    </button>
                </div>
            </div>
                                    ...
                                    <thead class="text-gray-500 fs-7">
                                        <tr role="row"
                                            ...
                                            <th class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom"
                                                style="min-width: 10rem">Patient Name</th>
                                            <th class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom"
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        reinitTooltips();
        reinitAllMetronicMenus(); // Your existing menu reinit
    });
