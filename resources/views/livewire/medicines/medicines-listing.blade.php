            ...
            <div class="mb-5 form-group row bg-search">
                <div class="col-lg-4">
                    <input type="text" wire:model.live.debounce.500ms="q" id="q" name="q"
                           ...
                           placeholder="Search Medicine" value="" maxlength="50">
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-bordered table-row-dashed gy-4 fw-bold dataTable">
                            ...
                            <tbody class="fs-6">
                                ...
                                @else
                                    <tr>
                                        <td colspan="5" class="text-center">No records found @if($q || $status || $verification_status) for the applied filters @endif</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
