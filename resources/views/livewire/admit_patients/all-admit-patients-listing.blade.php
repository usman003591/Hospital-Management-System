    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="mb-5 form-group row bg-search">
                ...
                <div class="col-lg-2">
                    <select wire:model.live="department" id="department" class="form-select form-select-solid bg-body-secondary"
                        data-placeholder="Select Department" data-allow-clear="true">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start dt-toolbar">
                                <div>
                                    ...
                                    @else
                                        No records found @if(request()->has('q') || request()->has('department') || request()->has('ward') || request()->has('status')) for the applied filters @endif
                                    @endif
                                </div>
                            </div>
