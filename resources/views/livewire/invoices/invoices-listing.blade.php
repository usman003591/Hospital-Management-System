            ...
            <div class="mb-5 form-group row bg-search">
                <div class="col-lg-8 w-50">
                    <input type="text" wire:model.live.debounce.500ms="q" id="q" name="invoice_search"
                        ...
                        placeholder="Search by Receipt Number, Patient Name, Mobile Number" value="" maxlength="50" style="width: 100% !important;">
                </div>
                                    ...
                                    <thead class="text-gray-500 fs-7 text-uppercase">
                                        <tr role="row"
                                            ...
                                            <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="6"
                                                rowspan="1" colspan="1" aria-label="Payment Status: Activate to sort" tabindex="0"
                                                style="min-width: 10rem"><span class="dt-column-title"
