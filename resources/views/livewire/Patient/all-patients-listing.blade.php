        ...
        <div class="col-md-12">
            ...
            <div class="mb-5 form-group row bg-search">
                {{-- <div class="col-lg-6">
                    <input type="text" wire:model.live.debounce.500ms="q" id="q" name="patient_search"
                        class="mb-3 ajax_call_trigger form-control form-control-solid mb-lg-0 bg-body-secondary search-input"
                        placeholder="Search Patient by Name, MR Number or CNIC or Mobile Number" value=""
                        maxlength="50">
                </div> --}}
                <div class="col-lg-7">
                        ...
                        <div id="kt_project_users_table_wrapper" class="dt-container dt-bootstrap5 dt-empty-footer">
                            <div class="table-responsive">
                                <table id="kt_project_users_table"
                                    class="table align-middle table-row-bordered table-row-dashed gy-4"
                                    style="width: 100%;">
                                    <thead class="text-gray-500 fs-7 text-uppercase">
                                        <tr role="row"
                                            ...
                                            <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="1"
                                                rowspan="1" colspan="1" aria-label="MR Number: Activate to sort"
                                                tabindex="0" style="min-width: 10rem"><span class="dt-column-title"
                                                    role="button">MR Number</span><span class="dt-column-order"></span>
                                            </th>

                                            <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="2"
                                                rowspan="1" colspan="1" aria-label="Created At: Activate to sort"
                                                tabindex="0" style="min-width: 13rem"><span class="dt-column-title"
                                                    role="button">Created At</span><span class="dt-column-order"></span>
                                            </th>
                                    ...
                                    <tbody class="fs-6">
                                        ...
                                        <tr class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <a href="{{ route('patients.detail_page', $d->id) }}"
                                                            ...
                                                            ucwords(strtolower($d->name_of_patient ?? 'Unnamed
                                                            Patient')) }}</a>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <a title="Detail"
                                                        href="{{ route('patients.detail_page', $d->id) }}"><button
                                        ...
                                        @else
                                        <tr>
                                            <td colspan="4" class="text-center"><small class="text-danger">No records
                                                    found</small></td>
                                        </tr>
                                        @endif
                                    </tbody>
