            ...
            <div class="mb-5 card mb-xl-8">
                ...
                <div class="pt-5 border-0 card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="mb-1 card-label fw-bold fs-3">Recent Services Invoices</span>
                    </h3>
                ...
                <div class="py-3 card-body">
                    <div class="table-responsive">
                        <table class="table align-middle table-row-bordered table-row-gray-100 gs-0 gy-3">
                            ...
                            <tbody>
                                @forelse ($data as $d)
                                <tr wire:key="service-category-invoice-{{ $d->id }}">
                                    <td>
                                   ...
                                   <td class="text-gray-900 text-hover-primary fs-6">
                                    ...
                                    <td>{!! getFinanceApprovalStatusLabel($d->is_finance_verified) !!}</td>

                                    <td class="text-center">
                                        @if(checkPersonPermission('detail_service_invoices_verification_62'))
                                       <a title="Detail" href="{{route('finance.service_categories_invoices_verification_detail', ['id' => $d->id])}}"
                                    ...
                                    <a title="Download Receipt" target="_blank" href="{{ route('finance.download_service_category_invoice', $d->id) }}"
                                        class="btn btn-icon btn-active-color-primary w-30px h-30px">
