            ...
            <div class="mb-5 form-group row bg-search">
                ...
                <div class="col-lg-6">
                    <input type="text" wire:model.live.debounce.500ms="q" id="q" name="user_name"
                        ...
                        placeholder="Search Invoice" value="" maxlength="50">
                </div>
            ...
            <div class="mb-5 card mb-xl-8">
                ...
                <div class="pt-5 border-0 card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="mb-1 card-label fw-bold fs-3">Recent Pharmacy Invoices</span>
                        {{-- <span class="mt-1 text-muted fw-semibold fs-7">Over 500 invoices</span> --}}
                    </h3>
                        ...
                        <table class="table align-middle table-row-bordered table-row-gray-100 gs-0 gy-3">
                            ...
                            <thead>
                                <tr class="fw-bold text-muted">
                                    ...
                                    <th class="min-w-120px">Discount Percentage</th>
                            ...
                            <tbody>
                                @if (count($data) > 0)
                                @foreach ($data as $d)
                                <tr wire:key="pharmacy-invoice-{{ $d->id }}">
                                    <td>
                                    ...
                                    <td class="text-gray-900 text-hover-primary fs-6">
                                        {{\Carbon\Carbon::parse($d->date_issued)->format('Y-m-d') }}
                                    </td>
                                    <td class="text-gray-900 text-hover-primary fs-6">
                                        {{ number_format(intval($d->final_amount), 2) }}
                                    </td>
                                    <td class="text-gray-900 text-hover-primary fs-6">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a title="Detail"
                                            href="{{route('finance.pharmacy_invoices_verification_detail', ['id' => $d->id])}}"
                                        ...
                                        <a title="Download Receipt" target="_blank"
                                            href="{{ route('finance.download_pharmacy_invoice', $d->id) }}"
                                            class="btn btn-icon btn-active-color-primary w-30px h-30px">
