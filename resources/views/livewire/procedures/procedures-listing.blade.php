            ...
            <div class="mb-5 form-group row bg-search">
                <div class="col-lg-4">
                    <input type="text" wire:model.live.debounce.500ms="q" id="q" name="q"
                           ...
                           placeholder="Search Procedure" value="" maxlength="50">
                </div>
                <div class="col-lg-3">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-bordered table-row-dashed gy-4 fw-bold dataTable">
                            ...
                            <tbody class="fs-6">
                                ...
                                @else
                                    <tr>
                                        <td colspan="7" class="text-center">No records found @if($q || $verification_status) for the applied filters @endif</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
                        <div class="row">
                            <div class="col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start dt-toolbar">
                                <div>
                                    ...
                                    @else
                                        No records found @if($q || $verification_status) for the applied filters @endif
                                    @endif
                                </div>
                            </div>
