            ...
            <div class="mb-5 form-group row bg-search">
                <div class="col-lg-4">
                    <input type="text" wire:model.live.debounce.500ms="q" id="q" name="q"
                           ...
                           placeholder="Search by Patient Name" value="" maxlength="50">
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-2">
                    <select wire:model.live="doctor_id" id="doctor"
                            class="form-select form-select-solid bg-body-secondary">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-bordered table-row-dashed gy-4 fw-bold dataTable">
                            ...
                            <tr role="row" class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                <th class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom"
                                    ...
                                    tabindex="0" style="min-width: 10rem"><span class="dt-column-title">Hospital
                                ...
                                <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="3" rowspan="1"
                                    ...
                                    style="min-width: 10rem"><span class="dt-column-title">Patient</span><span
                                        class="dt-column-order"></span></th>

                                <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="3" rowspan="1"
                                    colspan="1" aria-label="Status: Activate to sort" tabindex="0"
                                    style="min-width: 6rem"><span class="dt-column-title">Prefered Date</span><span
                                        class="dt-column-order"></span></th>
                                <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="3" rowspan="1"
                                    colspan="1" aria-label="Status: Activate to sort" tabindex="0"
                                    style="min-width: 6rem"><span class="dt-column-title">Prefered Time</span><span
                                        class="dt-column-order"></span></th>
                                <th class="dt-orderable-asc dt-orderable-desc text-center" data-dt-column="3"
                                    rowspan="1" colspan="1" aria-label="Status: Activate to sort" tabindex="0"
                                    style="min-width: 5rem"><span class="dt-column-title">Visitor</span><span
                                        class="dt-column-order"></span></th>
                                ...
                                <th class="text-center dt-orderable-none" data-dt-column="4" rowspan="1" colspan="1"
                                    aria-label="Details" style="min-width: 8rem"><span
                        ...
                        <tbody class="fs-6">
                            ...
                            <tr class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                ...
                                <td>{{ \Carbon\Carbon::parse($d->preferred_time)->format('g:i A') }}</td>
                                <td class="text-center">
                                    @if ( $d->is_visitor == 0)
                                    No
                                    @else
                                    <div class="text-center">
                                        <a href="{{route('patients.create')}}" class="btn btn-sm btn-primary">Yes,
                                            Register</a>
                                    </div>
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if ($d->appointment_request_status == 'pending')
                                    <span class="px-4 py-2 badge badge-warning font-weight-lighter">Pending</span>
                                    @elseif($d->appointment_request_status == 'approved')
                                    <span class="px-4 py-2 badge badge-success font-weight-lighter">Approved</span>
                                    @elseif($d->appointment_request_status == 'cancelled')
                                    <span class="px-4 py-2 badge badge-danger font-weight-lighter">Cancelled</span>
                                    @endif
                                </td>
                                <td class="align-middle text-end">
                                    <div class="d-flex justify-content-center align-items-center">
                                        @if (checkPersonPermission('detail_appointment_requests_39'))
                                        <a title="Detail" href="{{route($page.'.show',$d->id)}}"><button
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start dt-toolbar">
                                <div>
                                    ...
                                    @else
                                        No records found @if($q || $hospital_id || $doctor_id || $status) for the applied filters @endif
                                    @endif
                                </div>
                            </div>
