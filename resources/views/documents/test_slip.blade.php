    ...
    <div class="page" style="width:100%;">
        ...
        <div class="container" style="float:left; width:46%;">
                    ...
                    <table style="width: 100%; table-layout: fixed; border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="width: 20%; text-align: left; vertical-align: middle;">
                                <img src="data:image/png;base64,{{ $logo }}" width="70" height="70" alt="Logo">
                            </td>

                            <!-- Center: Hospital Name -->
                            <td class="title-section" style="text-align: center; vertical-align: middle;">
                                <div style="margin-top: 5px;">
                                    <h2 style="margin: 0; font-size: 20px;"><strong>Smart City Hospital</strong></h2>
                                    <h4 style="margin: 0; font-size: 14px;"><strong>(SCH)</strong></h4>
                            ...
                            <td style="width: 20%; text-align: right; vertical-align: middle;">
                                <div style="display: inline-block; text-align: center;">
                                    <img src="data:image/png;base64,{{ $qrCode }}" width="70" height="70" alt="QR Code">
            ...
            <div class="reciept-info">
                <p style="float: left; margin: 0px;">&nbsp;Receipt #: RCF-00123</p>
            </div>
        ...
        <div class="container" style="float:right; width:46%;">
            ...
            <table style="width: 100%; table-layout: fixed; border-collapse: collapse;">
                <tr>
                    ...
                    <td class="title-section" style="text-align: center; vertical-align: middle;">
                        <div style="margin-top: 5px;">
                            <h3 style="margin: 0; font-size: 20px;"><strong>Smart City Hospital</strong></h3>
                            <h4 style="margin: 0; font-size: 14px;"><strong>(SCH)</strong></h4>
