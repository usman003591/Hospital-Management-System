                ...
                <tr>
                    ...
                    <td class="title-section">
                        <div style="margin-top: 20px">
                            <h3><u>{{$hospital->name}} ({{$hospital->hospital_abbreviation}})  </u></h3>
                            <h3><u>Capital Smart City Islamabad</u></h3>
                ...
                <tbody>
                    {{-- <tr>
                        ...
                        <td class="value-left" colspan="3">
                            ...
                            {{ $prescription_data->counter_name }}
                            @endisset
                        </td>
                    ...
                    <tr>
                        ...
                        @isset($patient_data->designation)
                        <tr>
                            <th class="label-left">Designation:</th>
                            <td class="value-left" colspan="3">
                                {{$patient_data->designation}}
                            </td>
                            <th class="label-right"></th>
                            <td class="value-right" style="border: none"></td>
                        </tr>
                        @endisset
                </tbody>
            </table>
