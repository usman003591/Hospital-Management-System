        ...
        <div class="container">
                    ...
                    <table style="width: 100%; table-layout: fixed; border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="width: 20%; text-align: left; vertical-align: middle;">
                                <img src="{{'data:image/png;base64,'.base64_encode(file_get_contents(public_path($hospital->logo)))}}" width="90" height="90" alt="Logo">
                            </td>

                            <!-- Center: Hospital Name -->
                            <td class="title-section" style="text-align: center; vertical-align: middle;">
                                <div style="margin-top: 5px;">
                                    <h2 style="margin: 0; font-size: 25px;"><strong>{{$hospital->name}}</strong></h2>
                                    <h4 style="margin: 0; font-size: 16px;"><strong> ({{$hospital->hospital_abbreviation}})</strong></h4>
                                </div>
                            </td>

                            <td style="width: 20%; text-align: right; vertical-align: middle;">
                                <div style="display: inline-block; text-align: center;">
                                    <img src="data:image/png;base64,{{ base64_encode($qrCode) }}" width="90" height="90" alt="QR Code">
            ...
            <div class="comments-box">
             ...
             <table class="totals">
               <tr>
                    <td>Total Amount:</td>
                    <td>{{ $lab_invoice_data->total_amount }}</td>
                </tr>
                <tr>
                    <td>Discount:</td>
                    <td>@isset($lab_invoice_data->discount_amount) {{$lab_invoice_data->discount_amount}} @endisset</td>
                </tr>
                <tr>
                    <td>Net Amount:</td>
                    <td>{{ $lab_invoice_data->net_amount }}</td>
                </tr>
                {{-- <tr>
                        <td>Balance:</td>
                        <td>0</td>
                ...
                <tr>
                    ...
                    <td>{{ $lab_invoice_data->amount_received }}</td>
                </tr>
            </table>
            </div>
