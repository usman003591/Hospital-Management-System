                    ...
                    <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
                     ...
                     {{ $activeMenu == 'radiology_management' ? ' menu-accordion hover show' : ' menu-accordion' }}
                     @else
                     menu-accordion
                     @endisset">
                            <!--begin:Menu link-->
                 ...
                 {{ $activeMenu == 'radiology_management' ? 'show' : '' }}
                 @endisset" @isset($activeMenu) {{ $activeMenu=='radiology_management' ? 'style=""'
                         ...
                         {{ $activeSubMenu == 'radiology' ? 'active' : '' }}
                         @endisset" href="">
