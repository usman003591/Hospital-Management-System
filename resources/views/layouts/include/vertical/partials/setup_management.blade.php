                    ...
                    <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item @isset($activeMenu)
                            {{ $activeMenu == 'setup_management' ? ' menu-accordion hover show' : ' menu-accordion' }}
                            @else
                            menu-accordion
                            @endisset">
                            <!--begin:Menu link-->
                        ...
                        {{ $activeMenu == 'setup_management' ? 'show' : '' }}
                        @endisset" @isset($activeMenu) {{ $activeMenu=='setup_management' ? 'style=""'
