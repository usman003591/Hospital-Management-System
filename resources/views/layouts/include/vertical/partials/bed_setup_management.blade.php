                  @if (auth()->user()->role_id == 1)
                    {{-- bed setup starts here --}}
                    <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
                        id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                        <!--begin:Menu item-->
                        <div data-kt-menu-trigger="click" class="menu-item @isset($activeMenu)
                                    {{ $activeMenu == 'bed_setup_management' ? ' menu-accordion hover show' : ' menu-accordion' }}
                                    @else
                                    menu-accordion
                                    @endisset">
                            <!--begin:Menu link-->
                            <span class="menu-link">
                                ...
                                <span class="menu-title">Bed Setup </span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion @isset($activeMenu)
                                {{ $activeMenu == 'bed_setup_management' ? 'show' : '' }}
                                @endisset" @isset($activeMenu) {{ $activeMenu=='bed_setup_management' ? 'style=""'
                                ...
                                <div class="menu-item">
                                    ...
                                    <a class="menu-link @isset($activeSubMenu)
                                        {{ $activeSubMenu == 'bed_setup' ? 'active' : '' }}
                                        @endisset" href="">
