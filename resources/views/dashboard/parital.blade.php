<div class="row">
    ...
    <div class="mb-10 col-xl-12 col-md-12">
        ...
        <div class="card card-flush h-xl-100">
            <!--begin::Heading-->
            <div class="rounded card-header bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style="background-image:url('assets/media/svg/shapes/top-green.png" data-bs-theme="light">
                <!--begin::Title-->
                <h3 class="text-white card-title align-items-start flex-column pt-15">
                    <span class="mb-3 fw-bold fs-2x">HMS Stats</span>
                                                        ...
                                                        <div class="row g-3 g-lg-6">
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <div class="px-6 py-5 bg-gray-100 bg-opacity-70 rounded-2">
                                                                    ...
                                                                    <div class="m-0">
                                                                        <!--begin::Number-->
                                                                        <span class="mb-1 text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1">37</span>
                                                                        <!--end::Number-->
                                                                        <!--begin::Desc-->
															...
															<div class="col-6">
																...
																<div class="px-6 py-5 bg-gray-100 bg-opacity-70 rounded-2">
																	...
																	<div class="m-0">
																		<!--begin::Number-->
																		<span class="mb-1 text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1">6</span>
																		<!--end::Number-->
																		<!--begin::Desc-->
															...
															<div class="col-6">
																...
																<div class="px-6 py-5 bg-gray-100 bg-opacity-70 rounded-2">
																	...
																	<div class="m-0">
																		<!--begin::Number-->
																		<span class="mb-1 text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1">4,7</span>
																		<!--end::Number-->
																		<!--begin::Desc-->
															...
															<div class="col-6">
																...
																<div class="px-6 py-5 bg-gray-100 bg-opacity-70 rounded-2">
																	...
																	<div class="m-0">
																		<!--begin::Number-->
																		<span class="mb-1 text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1">822</span>
																		<!--end::Number-->
																		<!--begin::Desc-->
