@extends('layouts.master',['activeMenu' => 'performance', 'activeSubMenu' => 'pharmacy_dashboard', 'activeThirdMenu' =>'pharmacy_dashboard'])
@section('styles')
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="">
                    <span></span>
                    <li class="breadcrumb-item text-muted text-hover-primary">Pharmacy Dashboard</li>
                </a>
...
@if (checkPersonPermission('dashboard_actions_pharmacy_dashboard_73'))
        ...
        <div class="card h-lg-60" style="background-color: #0148a5">
            <div class="card-body">
                ...
                <div class="d-flex flex-column align-items-start my-7">
                    <div class="m-0">
                        <span class="text-white fw-semibold fs-1">Add New Inventory</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-6 col-xl-4 mb-xl-10">
        ...
        <div class="card h-lg-60" style="background-color: #0148a5">
            <div class="card-body">
                ...
                <div class="d-flex flex-column align-items-start my-7">
                    <div class="m-0">
                        <span class="text-white fw-semibold fs-1">Search Inventory</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card h-lg-60" style="background-color: #0148a5">
            <div class="card-body">
                ...
                <div class="d-flex flex-column align-items-start my-7">
                    <div class="m-0">
                        <span class="text-white fw-semibold fs-1">Search Patient Medicine</span>
                    </div>
                </div>
            </div>
        </div>
...
@endif
@if (checkPersonPermission('dashboard_stats_pharmacy_dashboard_73'))
                ...
                <div class="card card-flush h-xl-100" style="background-color: #01a54e">
                    ...
                    <div class="pt-5 text-center card-body">
                        ...
                        <div class="text-start">
                            <span class="text-white d-block fw-bold fs-1">{{ $stats['daily']['total_amount'] }} Total</span>
                            <span class="text-white mt-1 fw-semibold fs-3" style="color:">{{ $stats['daily']['discount_amount'] }} Discount</span><br>
                            <span class="text-white mt-1 fw-semibold fs-3" style="color:">{{ $stats['daily']['received_amount'] }} Received</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card card-flush h-xl-100" style="background-color: #c31318">
                    ...
                    <div class="pt-5 text-center card-body">
                        <img src="assets/media/svg/illustrations/easy/1.svg" class="mb-5 h-125px" alt="">
                        <div class="text-start">
                            <span class="text-white d-block fw-bold fs-1">{{ $stats['weekly']['total_amount'] }} Total</span>
                            <span class="text-white mt-1 fw-semibold fs-3" style="color:">{{ $stats['weekly']['discount_amount'] }} Discount</span><br>
                            <span class="text-white mt-1 fw-semibold fs-3" style="color:">{{ $stats['weekly']['received_amount'] }} Received</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card card-flush h-xl-100" style="background-color: #f5811e">
                    ...
                    <div class="pt-5 text-center card-body">
                        <img src="assets/media/svg/illustrations/easy/1.svg" class="mb-5 h-125px" alt="">
                        <div class="text-start">
                            <span class="text-white d-block fw-bold fs-1">{{ $stats['monthly']['total_amount'] }} Total</span>
                            <span class="text-white mt-1 fw-semibold fs-3" style="color:">{{ $stats['monthly']['discount_amount'] }} Discount</span><br>
                            <span class="text-white mt-1 fw-semibold fs-3" style="color:">{{ $stats['monthly']['received_amount'] }} Received</span>
                        </div>
                    </div>
                </div>
            </div>
