@extends('layouts.master', ['activeMenu' => 'appointment_management', 'activeSubMenu' => 'doctor_appointments_all', 'activeThirdMenu' => $page])
@section('breadcrumbs')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                @include('modules.' . $page . '.include.search_doctor_appointments')
                @endif
...
@section('scripts')
<script src="{{getAssetsURLs('js/custom/logged_in_doctor_appointments.js')}}"></script>
