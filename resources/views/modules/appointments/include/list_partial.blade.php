                                ...
                                @foreach ($data as $d)
                                    <tr class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <a href="" class="mb-1 text-gray-800 text-hover-primary">
                                                        @isset($d->patient_name)
                                                            {{ $d->patient_name }} - {{ $d->patient_mr_number }}
                                                        @endisset
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <td class="text-center">
                                            @if ($d->appointment_status == 'pending' || $d->appointment_status == 'Pending')
                                                <span
                                                    class="px-4 py-2 badge badge-warning font-weight-lighter">{{ ucfirst($d->appointment_status) }}</span>
                                            @elseif($d->appointment_status == 'approved' || $d->appointment_status == 'Approved')
                                                <span
                                                    class="px-4 py-2 badge badge-success font-weight-lighter">{{ ucfirst($d->appointment_status) }}</span>
                                            @elseif($d->appointment_status == 'cancelled' || $d->appointment_status == 'Cancelled')
                                                <span
                                                    class="px-4 py-2 badge badge-danger font-weight-lighter">{{ ucfirst($d->appointment_status) }}</span>
                                            @endif
                                        </td>
