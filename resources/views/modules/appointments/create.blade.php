                ...
                <div class="mb-15">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control form-select" name="doctor_id" data-live-search="true"
                                ...
                                <option value="{{$doctor->id}}" {{ "$doctor->id" === old('doctor_id') ? 'selected' : '' }}> {{$doctor->doctor_name}} - {{ $doctor->department_name
                                    }} </option>
                                @endforeach
                                @endisset
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control form-select" name="patient_id" data-live-search="true"
                                ...
                                <option value="{{$patient->id}}" {{ "$patient->id" === old('patient_id') ? 'selected' : '' }}> {{$patient->name_of_patient}} - {{$patient->cnic_number}} - {{$patient->patient_mr_number}} </option>
                                @endforeach
                                @endisset
                            </select>
                            @error('patient_id')
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Time <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="time" name="time" class="form-control" id="timeInput" value="{{ old('time') }}">
                            @error('time')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
