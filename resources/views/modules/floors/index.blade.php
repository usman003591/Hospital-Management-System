...
@extends('layouts.master', ['activeMenu' => 'hospital_setups_management', 'activeSubMenu' => 'floors', 'activeThirdMenu' => 'floors'])
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <livewire:hospital-floors.all-hospital-floors-listing/>
            </div>
        </div>
    </div>
