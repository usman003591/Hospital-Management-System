    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="{{route('admit_patients.create')}}">
                    <span></span>
            ...
            <div class="card-body">
                ...
                <div class="mb-15">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select name="ward_id" class="form-control form-select" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select name="bed_id" class="form-control form-select" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="admission_date" id="admissionDate" class="form-control"
                                value="{{ old('admission_date') }}" required placeholder="DD/MM/YYYY HH:mm" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="discharge_date" id="dischargeDate" class="form-control datetimepicker"
                                value="{{ old('discharge_date') }}" placeholder="DD/MM/YYYY HH:mm" />
