@php $page='general_physical_examinations';
$sc = 'General Physical Examination';
@endphp
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <a href="{{route('general_physical_examinations.index')}}">
                    <span></span>
                    <li class="breadcrumb-item text-muted text-hover-primary">General Physical Examinations</li>
                </a>
                <!--end::Item-->
                ...
                <a href="{{route('general_physical_examinations.edit', $obj->id)}}">
                    <span></span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="name" class="form-control"
                                placeholder="Enter general physical examination name" value="{{$obj->name}}"
