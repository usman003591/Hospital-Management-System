@php $page='prescriptions'; @endphp
@extends('layouts.master',['activeMenu' => 'prescriptions_management', 'activeSubMenu' => 'prescriptions',
'activeThirdMenu' => 'prescriptions'])
@section('breadcrumbs')
                ...
                <div class="mb-15">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <label
                                class="text-right col-form-label">{{getActiveHospitalName($preferences['preference']['hospital_id']
                                )}}</label>
                    ...
                    {{-- <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Token <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ old('token_number') }}" --}} {{--
                                oninput="this.value = this.value.replace(/[^a-zA-Z\s.-]/g, '')" --}} {{--
                                name="token_number" class="form-control" maxlength="50" placeholder="Enter Token" />
                            --}}
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Counter <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <select class="form-control form-select" name="counter_id" data-live-search="true"
                                id="kt_select2_1">
                                ...
                                @if ($loop->first)
                                <option value="{{ $counter->id }}" selected>
                                    {{ $counter->name }} </option>
                                @else
                                <option value="{{ $counter->id }}" {{ "$counter->id"===old('counter_id') ? 'selected'
                                    : '' }}>
                                    {{ $counter->name }} </option>
                                @endif
...
{{-- <script>
$('#submitPrescriptions').on('click', function () {
    let button = $(this);
