...
@extends('layouts.master', ['activeMenu' => 'prescriptions_management', 'activeSubMenu' => 'prescriptions', 'activeThirdMenu' => 'prescriptions'])
@section('breadcrumbs')
...
<livewire:prescriptions.all-prescriptions-listing/>
@else
<livewire:prescriptions.prescriptions-listing/> <!-- Adjust if needed -->
@endif
