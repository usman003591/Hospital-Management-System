            ...
            <div class="card-body">
                ...
                <div class="mb-15">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="ward_name" class="form-control" value="{{ old('ward_name') }}"
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Description<span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <textarea name="ward_description" class="form-control" id="ward_description" cols="30" rows="5"
                                maxlength="250" placeholder="Enter description">{{ old('ward_description')}}</textarea>
