    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="{{route('wards.edit', $obj->id)}}">
                    <span></span>
            ...
            <div class="card-body">
                ...
                <div class="mb-15">
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Floor <span class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <select name="floor_id" class="form-control" required>
                                <option value="">Select Floor</option>
                                @foreach($floors as $floor)
                                    <option value="{{ $floor->id }}" {{ $obj->floor_id == $floor->id ? 'selected' : '' }}>
                                        {{ $floor->floor_name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <br>
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Ward Title <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" name="ward_name" class="form-control" placeholder="Enter ward title"
                                value="{{$obj->ward_name}}"
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Description <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <textarea name="ward_description" class="form-control" placeholder="Enter description"
                                id="ward_description" cols="30" rows="5" maxlength="250">{{ $obj->ward_description }}</textarea>
                            <div>
