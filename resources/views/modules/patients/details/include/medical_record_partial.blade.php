                    ...
                    <table id="kt_project_users_table"
                        ...
                        <thead class="text-gray-500 fs-7 text-uppercase">
                            <tr role="row" class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                ...
                                rowspan="1" colspan="1" aria-label="Amount: Activate to sort" tabindex="0"
                                style="min-width: 15rem"><span class="dt-column-title"
                                    role="button">Start Date</span><span class="dt-column-order"></span></th>
                                <th class="dt-type-numeric dt-orderable-asc dt-orderable-desc" data-dt-column="2"
                                rowspan="1" colspan="1" aria-label="Amount: Activate to sort" tabindex="0"
                                style="min-width: 15rem"><span class="dt-column-title"
                                    role="button">End Date</span><span class="dt-column-order"></span></th>
                            ...
                            <tr class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <a href="" class="mb-1 text-gray-800 text-hover-primary">@isset($d->patient_name)
                                                {{$d->patient_name}}
                                                @endisset </a>
                                        </div>
                                        <!--end::Info-->
                                ...
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Info-->
                                        <div class="d-flex flex-column justify-content-center">
                                            <a href="" class="mb-1 text-gray-800 text-hover-primary">@isset($d->doctor_name)
                                                {{$d->doctor_name}}
                                                @endisset </a>
                                        </div>
                                        <!--end::Info-->
                                ...
                                <td data-order="2024-06-20T00:00:00+05:00">{{getDateInStandardFormat(Carbon\Carbon::parse($d->start_date))}}</td>
                                <td data-order="2024-06-20T00:00:00+05:00">{{getDateInStandardFormat(Carbon\Carbon::parse($d->end_date))}}</td>
                                {{-- <td data-order="2024-06-20T00:00:00+05:00">{{getDateInStandardFormat(Carbon\Carbon::parse($d->created_at))}}</td> --}}
