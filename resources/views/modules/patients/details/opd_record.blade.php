...
@include('modules.patients.details.include.nav_partial',['tab' => 'opd_record'])
@include('modules.patients.details.include.medical_record_partial',['page'=>'clinical_diagnosis'])
