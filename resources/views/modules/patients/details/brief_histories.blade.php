...
@include('modules.patients.details.include.nav_partial',['tab' => 'patient_brief_history'])
<!--begin::Card-->
<div class="card card-flush">
    <div class="card-header">
        <h3 class="card-title">Brief Histories</h3>
    </div>
    <!--begin::Card body-->
    <div class="card-body card-scroll h-500px">
         <livewire:patient-details.brief-history-list :patientId="$patient->id" />
    </div>
    <!--end::Card body-->
</div>
<!--end::Card-->
