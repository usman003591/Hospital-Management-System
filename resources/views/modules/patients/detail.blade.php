 ...
 <div class="container">
     ...
     <div class="p-4 card">
         ...
         <div class="mb-2 row">
            ...
            <div class="col-md-9">{{ $patient->name_of_patient }}</div>
        </div>
    </br>
         <div class="mb-2 row">
             <div class="col-md-3"><strong>CNIC No:</strong></div>
             <div class="col-md-9">{{ $patient->cnic_number}}</div>
         </div>
        </br>
        <div class="mb-2 row">
       ...
       <div class="mb-2 row">
        ...
        <div class="col-md-9">{{ $patient->date_of_birth}}</div>
    </div>
        </br>
       <div class="mb-2 row">
        <div class="col-md-3"><strong>Cell:</strong></div>
        <div class="col-md-9">{{ $patient->cell }}</div>
    </div>
   </br>
   <div class="mb-2 row">
    <div class="col-md-3"><strong>Blood Group:</strong></div>
    <div class="col-md-9">{{ $patient->blood_group }}</div>
</div>
</br>
       ...
       <div class="mb-2 row">
        <div class="col-md-3"><strong>Permanent Addres:</strong></div>
        <div class="col-md-9">{{ $patient->permanent_address }}</div>
    </div>
   </br>
   <div class="mb-2 row">
    <div class="col-md-3"><strong>Category:</strong></div>
    <div class="col-md-9">{{ $patient->patient_category }}</div>
</div>
</br>
       <div class="mb-2 row">
