            ...
            <div class="card-body">
               ...
               <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input type="text" id="title" name="name" class="form-control" value="{{ old('name') }}" placeholder="Enter name" maxlength="100" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input type="text" id="slug" name="notification_slug" class="form-control" value="{{ old('notification_slug') }}" placeholder="Enter slug" readonly>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <textarea name="description" id="en_description" class="form-control" rows="3" placeholder="Enter description" maxlength="500">{{ old('description') }}</textarea>
                    ...
                    <div class="col-lg-6">
                        <select name="notification_category_id" class="form-control" required>
                            ...
                            @foreach($categories as $cat)
                                <option value="{{ $cat->id }}" {{ old('notification_category_id') == $cat->id ? 'selected' : '' }}>
                                    {{ $cat->name }}
                                </option>
                            @endforeach
                        </select>
