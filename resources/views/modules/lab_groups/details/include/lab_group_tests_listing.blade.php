            ...
            <thead class="text-gray-500 fs-7 text-uppercase">
                <tr>
                    <th class="min-w-250px dt-orderable-asc dt-orderable-desc" data-dt-column="0" rowspan="1"
                        colspan="1" aria-label="Manager: Activate to sort" tabindex="0"><span class="dt-column-title"
                            role="button">Investigation Name</span><span class="dt-column-order"></span></th>
            ...
            <tbody class="fs-6">
                ...
                <tr>
                    ...
                    <td>@isset($d->lab_group_number)
                        {{$d->lab_group_number}}
                        @endisset</td>
                    <td data-order="2025-08-19T00:00:00+05:00">@isset($d->report_date) {{ getBasicDateTimeFormat($d->report_date) }} @endisset</td>
                    <td data-order="2025-08-19T00:00:00+05:00">@isset($d->received_date) {{ getBasicDateTimeFormat($d->received_date) }} @endisset</td>
                    ...
                    <td class="text-end">
                     ...
                     @if(checkPersonPermission('download_lab_test_lab_group_detail_56'))
                        ...
                        <a title="Download Lab Report" target="_blank" href="{{route('lab_tests.download',$d->id)}}"><button
                  ...
                  <div id="" class="row">
                    <div id=""
                        ...
                        <div>
                            ...
                            Showing {{ $lab_group_tests->firstItem() }} to {{ $lab_group_tests->lastItem() }} of {{ $lab_group_tests->total() }} records
                            @else
                            No records found
