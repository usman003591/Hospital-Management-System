                    ...
                    <table id="kt_project_users_table"
                        ...
                        <thead class="text-gray-500 fs-7 text-uppercase">
                            <tr role="row" class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                ...
                                <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="1" rowspan="1"
                                    colspan="1" aria-label="Date: Activate to sort" tabindex="0"
                                    style="min-width: 7rem"><span class="dt-column-title">MR Number</span><span
                                        class="dt-column-order"></span>
                                </th>
                                <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="1" rowspan="1"
                                    colspan="1" aria-label="Date: Activate to sort" tabindex="0"
                        ...
                        <tbody class="fs-6">
                            ...
                            <tr class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                ...
                                <td class="mb-1 text-gray-800 text-hover-primary">@isset($d->lab_group_number)
                                    {{$d->lab_group_number}}
                                    @endisset
                                </td>
                                </a>
                               ...
                               {{-- @if(checkPersonPermission('change_status_lab_groups_55')) --}}
                                ...
                                <td class="mb-1 text-gray-800 text-hover-primary">@isset($d->patient_mr_number)
                                    {{$d->patient_mr_number}}
                                    @endisset
                                </td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center align-items-center">
                                        ...
                                        <a title="QrCode" href="{{ route($page . '.lab_code', $d->id) }}">
                                        <button class="btn btn-icon btn-active-light-primary w-30px h-30px">
                                             <i class="ki-outline ki-scan-barcode fs-1x text-warning"></i>
                                        </button>
                                        </a>

                                         @if(checkPersonPermission('detail_lab_groups_55'))
                                        <a title="Detail" href="{{route($page.'.detail',$d->id)}}"><button
