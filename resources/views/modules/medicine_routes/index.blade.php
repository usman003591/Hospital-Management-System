...
@extends('layouts.master', ['activeMenu' => 'settings_management', 'activeSubMenu' => 'medicine_routes', 'activeThirdMenu' => 'medicine_routes'])
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <livewire:medicine-routes.all-medicine-routes-listing />
            </div>
        </div>
    </div>

    @include('modules.medicine_routes.modals.delete')
@endsection
