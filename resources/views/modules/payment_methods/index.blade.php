...
@extends('layouts.master', ['activeMenu' => 'pharmacy_management', 'activeSubMenu' => 'payment_methods', 'activeThirdMenu' => 'payment_methods'])
@section('breadcrumbs')
                ...
                <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                    ...
                    <!--begin::Item-->
                        ...
                        <a href="{{ route('payment_methods.index') }}">
                            <li class="breadcrumb-item text-muted text-hover-primary">Payment Methods</li>
                        </a>
    ...
    <div class="row">
        <div class="col-md-12">
            @include('include.messages')
                <livewire:payment_methods.all-payment-methods-listing />
        </div>
    </div>
</div>
