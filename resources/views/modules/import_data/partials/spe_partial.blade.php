<div class="mb-5 card card-xl-stretch mb-xl-12" style="width: 73.5rem">
    <form class="form" action="{{route('opd_spe.import')}}" method="POST"
        enctype="multipart/form-data">
        @csrf
        <div class="card-body" style="height:20vh">
            <h3 class="mb-6 font-size-lg text-dark font-weight-bold">1. Import Systemic Physical Examinations</h3>
            <div class="mb-15">
