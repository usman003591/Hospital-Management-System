...
@extends('layouts.master', ['activeMenu' => 'settings_management', 'activeSubMenu' => 'departments', 'activeThirdMenu' => 'departments'])
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <livewire:departments.all-departments-listing />
            </div>
        </div>
    </div>

    @include('modules.departments.modals.delete')
@endsection
