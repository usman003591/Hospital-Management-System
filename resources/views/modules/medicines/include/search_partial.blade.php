...
<div class="mb-5 form-group row bg-search">
    ...
    <div class="col-lg-4">
        <input type="text" id="q" name="user_name"
            ...
            placeholder="Search Medicine" value="{{$search['q']}}" maxlength="50">
    </div>
    ...
    <div class="col-lg-3">
        <select id="verification_status" class="form-select ajax_call_trigger form-select-solid bg-body-secondary"
            data-kt-select2="true" data-placeholder="Select Status" data-allow-clear="false">
