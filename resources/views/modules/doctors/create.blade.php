    ...
    <div class="mb-5 card card-xl-stretch mb-xl-8">
        ...
        <div class="col-lg-6">
          <select class="form-control form-select" name="opd_layout" required>
            ...
            <option value="modern" {{ old('opd_layout', $doctor->opd_layout ?? '') == 'modern' ? 'selected' : '' }}>Modern</option>
            <option value="simple" {{ old('opd_layout', $doctor->opd_layout ?? '') == 'simple' ? 'selected' : '' }}>Simple</option>
            <option value="advanced" {{ old('opd_layout', $doctor->opd_layout ?? '') == 'advanced' ? 'selected' : '' }}>Advanced</option>
           </select>
