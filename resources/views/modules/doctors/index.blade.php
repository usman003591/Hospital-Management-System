...
@extends('layouts.master',['activeMenu' => 'doctors_management', 'activeSubMenu' => 'doctors', 'activeThirdMenu' => 'doctors'])
@section('breadcrumbs')
...
<livewire:doctor.all-doctors-listing/>
@else
<livewire:doctor.doctors-listing/>
@endif
