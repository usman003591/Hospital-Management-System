@php $page='services_invoices'; @endphp
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <livewire:finance.verfication.service-categories />
        </div>
    </div>
</div>
@endsection
@section('scripts')
{{-- @include('modules.finance.verification.service_categories.scripts.multi_verify_script') --}}
