            ...
            <div class="flex-grow-1">
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex mb-4">
                        <livewire:finance.change-status.change-status-lab :invoiceId="$obj->id" />&nbsp;
                        ...
                        <a title="Download Receipt" target="_blank" class="btn btn-sm btn-info me-3"
                            href="{{ route('finance.download_pathology_invoice', $obj->id) }}"
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
            ...
            <li class="nav-item ">
                <a class="nav-link active text-active-primary py-5 me-6"
                    href="{{route('finance.pathology_invoices_verification_detail', ['id' => $obj->id])}}"
