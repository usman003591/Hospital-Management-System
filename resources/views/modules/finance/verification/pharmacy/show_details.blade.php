@php $page='pharmacy_invoices'; @endphp
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            @include('modules.finance.verification.pharmacy.include.nav_partial')
            @include('modules.finance.verification.pharmacy.include.audit_logs')
        </div>
    </div>
</div>
@endsection
