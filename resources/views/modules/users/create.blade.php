                ...
                <div class="mb-15">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative">
                                <input type="password" name="password" id="password" class="pr-5 form-control" placeholder="Enter password" maxlength="50"/>
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Role <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <select class="form-select form-control" name="role_id" data-live-search="true"
                                id="deviceSelect">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-select form-control" name="hospital_id" data-live-search="true"
                                ...
                                <option value="{{$hos->id}}" {{ "$hos->id"===old('hospital_id') ? 'selected' : '' }}>
                                    {{$hos->name}}
                                </option>
                                @endforeach
                                @endisset
                        ...
                        <div class="col-lg-6">
                            <select class="form-select form-control" name="user_type" id="user_type" data-live-search="true"
                              >
                                ...
                                <option value="Employee" {{ "Employee"===old('user_type') ? 'selected' : '' }}> Employee </option>
                                <option value="Doctor" {{ "Doctor"===old('user_type') ? 'selected' : '' }}> Doctor
                                </option>
                            </select>
                            <div>
                                @error('user_type')
...
<script>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Check if the user type is 'Doctor' and validation errors exist
            if (userType.value === "Doctor" || document.querySelectorAll('.is-invalid').length > 0) {
