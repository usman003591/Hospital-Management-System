...
@extends('layouts.master', ['activeMenu' => 'pharmacy_management', 'activeSubMenu' => 'order_statuses', 'activeThirdMenu' => 'order_statuses'])
@section('breadcrumbs')
    ...
    <div class="row">
        <div class="col-md-12">
            @include('include.messages')
                <livewire:order_statuses.all-order-statuses-listing />
        </div>
    </div>
</div>
