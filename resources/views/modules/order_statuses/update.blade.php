@php $page='order_statuses'; @endphp
@extends('layouts.master',['activeMenu' => 'pharmacy_management', 'activeSubMenu' => 'order_statuses', 'activeThirdMenu' =>
'order_statuses'])
@section('breadcrumbs')
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="{{route('order_statuses.edit', $obj->id)}}">
                    <span></span>
...
<div class="col-xl-12">
    ...
    <div class="mb-5 card card-xl-stretch mb-xl-8">
        ...
        <form class="form" action="{{route($page.'.update',$obj->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <h3 class="mb-6 font-size-lg text-dark font-weight-bold">1. Order Status Info </h3>
                <div class="mb-15">

                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Order Status Name <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{$obj->name}}" pattern="[A-Za-z\s]+"
                                name="name" class="form-control" placeholder="Enter Order Status name" {{--
