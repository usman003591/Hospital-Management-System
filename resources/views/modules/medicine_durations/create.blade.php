            ...
            <div class="card-body">
                ...
                <div class="mb-15">
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Medication Duration <span
                    ...
                    <br>
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Medication Duration Urdu Name <span
                            class="text-danger">*</span></label>
                        <div class="col-lg-6">
