@php $page='treatment_dose_interval';
$td = 'Treatment Dose Interval';
@endphp
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="{{route('treatment_dose_interval.index')}}">
                    <span></span>
                    <li class="breadcrumb-item text-muted text-hover-primary">Medication Dose Interval</li>
                </a>
                <!--end::Item-->
                ...
                <a href="{{route('treatment_dose_interval.edit', $obj->id)}}">
                    <span></span>
...
<div class="col-xl-12">
    ...
    <div class="mb-5 card card-xl-stretch mb-xl-8">
        ...
        <form class="form" action="{{route($page.'.update',$obj->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <h3 class="mb-6 font-size-lg text-dark font-weight-bold">1. {{ $td }} Info</h3>
                <div class="mb-15">

                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Medication Dose Interval Name <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" name="name" class="form-control" placeholder="Enter dose interval name"
                                value="{{$obj->name}}"
                    ...
                    <br>
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Medication Dose Interval Urdu Name <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
