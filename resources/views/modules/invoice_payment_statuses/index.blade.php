        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack" data-select2-id="select2-data-kt_app_toolbar_container">
            <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
                ...
                <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                    ...
                    <li>
                    <a href="{{ route('invoice_payment_statuses.index') }}">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <livewire:invoice-payment-statuses.all-invoice-payment-statuses-listing />
            </div>
        </div>
    </div>

    @include('modules.invoice_payment_statuses.modals.delete')
@endsection
