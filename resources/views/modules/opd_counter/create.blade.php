    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="{{route('opd_counter.create')}}">
                    <span></span>
...
<div class="col-xl-12">
    ...
    <div class="mb-5 card card-xl-stretch mb-xl-8">
        ...
        <form class="form" action="{{route($page.'.store')}}" method="POST" enctype="multipart/form-data"
            ...
            @csrf
            <div class="card-body">
                <h3 class="mb-6 font-size-lg text-dark font-weight-bold">1. OPD Counter Info</h3>
                <div class="mb-15">
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">OPD Counter <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ old('name') }}" {{--
                                oninput="this.value = this.value.replace(/[^a-zA-Z\s.-]/g, '')" --}}
                                name="name" class="form-control" maxlength="50"
                                placeholder="Enter OPD Counter" />
