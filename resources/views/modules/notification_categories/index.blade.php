        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
            ...
            <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
                ...
                <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <a href="{{ route('notification_categories.index') }}">
                        <span></span>
            ...
            <div class="gap-2 d-flex align-items-center gap-lg-3" data-select2-id="select2-data-122-cw9r">
                {{-- @if(checkPersonPermission('create_notification_categories_36')) --}}
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                {{-- @include('modules.notification_categories.include.list_partial') --}}
                <livewire:notifications.all-notification_categories-listing />
            </div>
        </div>
    </div>
