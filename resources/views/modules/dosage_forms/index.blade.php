...
@extends('layouts.master', ['activeMenu' => 'settings_management', 'activeSubMenu' => 'dosage_forms', 'activeThirdMenu' => 'dosage_forms'])
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <livewire:dosage-forms.all-dosage-forms-listing />
            </div>
        </div>
    </div>
