    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <a href="{{route('treatment_dosage.index')}}">
                    <span></span>
                    <li class="breadcrumb-item text-muted text-hover-primary">Medication Quantity</li>
                </a>
                <!--end::Item-->
                ...
                <a href="{{route('treatment_dosage.edit', $obj->id)}}">
                    <span></span>
...
<div class="col-xl-12">
    ...
    <div class="mb-5 card card-xl-stretch mb-xl-8">
        ...
        <form class="form" action="{{route($page.'.update',$obj->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <h3 class="mb-6 font-size-lg text-dark font-weight-bold">1. Medication Quantity Info</h3>
                <div class="mb-15">

                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Medication Quantity Name <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" name="name" class="form-control" placeholder="Enter quantity name"
                                value="{{$obj->name}}"
                    ...
                    <br>
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Medication Quantity Urdu Name <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" name="name_ur" class="form-control"  placeholder="علاج کی خوراک کا نام درج کریں"
                                value="{{$obj->name_ur}}"
                                oninput="this.value = this.value.replace(/[^a-zA-Z\s.{0-9}]/g, ''); capitalizeWords(this)" style="direction: rtl" />
                            {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                            <div>
                                @error('name_ur')
                                <small class="text-danger">{{ $message }}</small>
...
<script>
    function capitalizeWords(input) {
        ...
        // Join words to form new capitalized text
        let newText = words.join(' ');

        // Check if there's a change in text
        if (originalText !== newText) {
            // Update input value without losing cursor position
            let diff = newText.length - originalText.length;
            input.value = newText;
            let newCursorPos = start + diff; // Adjust cursor position
