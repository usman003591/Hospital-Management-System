    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <livewire:treatment-dosage.all-treatment-dosage-listing />
            </div>
        </div>
    </div>

    @include('modules.treatment_dosage.modals.delete')
@endsection
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.delete-{{ $page }}', function() {
                $('#kt_modal_delete_treatment_dosage_submit').attr('href', $(this).attr('href'));
                $('#kt_modal_delete_treatment_dosage').modal('show');
                return false;
            });

            $(document).on('click', '#kt_modal_delete_treatment_dosage_close', function() {
                $('#kt_modal_delete_treatment_dosage').modal('hide');
                return false;
            });

            $(document).on('click', '#kt_modal_delete_treatment_dosage_cancel', function() {
                $('#kt_modal_delete_treatment_dosage').modal('hide');
                return false;
            });

            $(document).on('click', '#kt_modal_delete_treatment_dosage_submit', function(event) {
