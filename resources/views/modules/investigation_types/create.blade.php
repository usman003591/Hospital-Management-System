        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="{{route('investigation_types.index')}}">
                    <span></span>
                    <li class="breadcrumb-item text-muted text-hover-primary">Investigation Types</li>
                </a>
                <!--end::Item-->
                ...
                <a href="{{route('investigation_types.create')}}">
                    <span></span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="name" class="form-control" value="{{ old('name') }}"
                                placeholder="Enter investigation type name"
