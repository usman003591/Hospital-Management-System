                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="name" class="form-control" value="{{ old('name') }}"
                                placeholder="Enter hospital name" maxlength="50" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="address" class="form-control" id="address" cols="30" rows="5"
                                maxlength="250" placeholder="Enter address">{{ old('address')}}</textarea>
                            {{-- <span class="form-text text-muted">We'll never share your email with anyone else</span>
                            --}}
                            <div>
                                @error('address')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="hospital_abbreviation" class="form-control"
                                value="{{ old('hospital_abbreviation') }}" placeholder="Enter hospital abbreviation"
                                maxlength="50" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="hospital_cell" class="form-control"
                                value="{{ old('hospital_cell') }}" placeholder="Enter hospital cell number"
                                maxlength="50" />
                            {{-- <span class="form-text text-muted">We'll never share your phone with anyone else</span>
                            --}}
                            <div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="hospital_phone" class="form-control"
                                value="{{ old('hospital_phone') }}" placeholder="Enter hospital phone number"
                                maxlength="50" />
                            <div>
