@php $page='hospitals'; @endphp
@extends('layouts.master',['activeMenu' => 'settings_management', 'activeSubMenu' => 'hospitals', 'activeThirdMenu' =>
'hospitals'])
@section('breadcrumbs')
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="{{route('hospitals.edit', $obj->id)}}">
                    <span></span>
...
<div class="col-xl-12">
    ...
    <div class="mb-5 card card-xl-stretch mb-xl-8">
        ...
        <form class="form" action="{{route($page.'.update',$obj->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <h3 class="mb-6 font-size-lg text-dark font-weight-bold">Hospital Info</h3>

                <div class="mb-15">
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Hospital Name <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" name="name"
                                {{-- oninput="this.value = this.value.replace(/[^a-zA-Z\s.-]/g, '')" --}}
                                class="form-control"
                                placeholder="Enter hospital name" value="{{$obj->name}}" maxlength="50" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            id="description" cols="30" rows="5" maxlength="250">{{ $obj->description }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="address" class="form-control" id="address" cols="30" rows="5"
                                maxlength="250" placeholder="Enter address">{{ $obj->address }}</textarea>
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Hospital Abbreviation <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" name="hospital_abbreviation" class="form-control"
                                placeholder="Enter hospital abbreviation" value="{{$obj->hospital_abbreviation}}"
                                maxlength="50" />
                            {{-- <span class="form-text text-muted">We'll never share your phone with anyone else</span>
                            --}}
                            <div>
                    ...
                    <br>
                               ...
                               <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Hospital Cell <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" name="hospital_cell" class="form-control"
                                value="@isset($obj->hospital_cell){{ $obj->hospital_cell }}@endisset" placeholder="Enter hospital cell number"
                                maxlength="50" />
                            {{-- <span class="form-text text-muted">We'll never share your phone with anyone else</span>
                            --}}
                            <div>
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Hospital Phone <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" name="hospital_phone" class="form-control"
                                value="@isset($obj->hospital_phone){{ $obj->hospital_phone }}@endisset" placeholder="Enter hospital phone number"
                                maxlength="50" />
                            <div>
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Logo <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                    ...
                    @php
                    if (file_exists($obj->logo)) {
                    $logo = $obj->logo;
                    } else {
                    $logo = getAssetsURLs('media/avatars/300-1.jpg');
                    }
                    @endphp

                    @if($logo)
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Current Logo</label>
                        <div class="col-lg-6">
                            <img height="100px" width="100px" src="@isset($logo){{url($logo)}}@endisset"
                                alt="">
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Project Logo</label>
                        <div class="col-lg-6">
                    ...
                    @php
                    if (file_exists($obj->project_logo)) {
                    $project_logo = $obj->project_logo;
                    } else {
                    $project_logo = getAssetsURLs('media/avatars/300-1.jpg');
                    }
                    @endphp

                    @if($project_logo)
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Current Project Logo</label>
                        <div class="col-lg-6">
                            <img height="100px" width="100px" src="@isset($project_logo){{url($project_logo)}}@endisset"
                                alt="">
                        </div>
                    </div>
                    <br>
