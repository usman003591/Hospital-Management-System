                      ...
                      height: 400px;">
                        ...
                        <div class="form-group">
                                ...
                                <div class="row" style="display: none;" id="followup_div">
                                    <div class="col-md-10">
                                        <label class="form-label">Follow Up date <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" data-date-format="DD MMMM YYYY" name="disposal_type_value" id="disposal_type_value" value="{{ now()->format('d/m/Y h:i A') }}" placeholder="dd/mm/YYYY hh:mm AA"/>
                                    </div>
                                </div>
