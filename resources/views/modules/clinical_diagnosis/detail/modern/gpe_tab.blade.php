                            ...
                            <div data-repeater-list="kt_docs_repeater_advanced_gpe">
                                        ...
                                        @foreach ($CdGeneralPhysicalExaminationData as $key => $gpe_data)
                                            ...
                                            <div data-repeater-item>
                                                <div class="mb-5 form-group row repeater-row-gpe">
                                                    <div class="col-md-3">
                                                        <label class="form-label">GPE <span
                                                                class="text-danger">*</span></label>
                                                        <select class="form-select selectGPE" name="selectGPE"
                                                            data-kt-repeater="gpe_select_2" data-placeholder="Select GPE">
                                                            <option></option>

                                                            @isset($general_physical_examinations)
                                                                @foreach ($general_physical_examinations as $item)
                                                                    <option value="{{ $item->id }}"
                                                                        @if ($item->id === $gpe_data->gpe_id) selected @endif>
                                                                        {{ $item->name }}
                                                                    </option>
                                                                @endforeach
                                                            @endisset
                                                        ...
                                                        @error('kt_docs_repeater_advanced_gpe.{{ $key }}.selectGPE')
                                                            <small class="text-danger">{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label class="form-label">Additional GPEs <span class="text-danger">*</span></label>
                                                        <select class="form-select selectSubGPE" name="selectSubGPE"
                                                            data-kt-repeater="sub_gpe_select_2" multiple
                                                            data-placeholder="Select addtional GPEs">
                                                            <option></option>
                                                    ...
                                                    <div class="pt-3 col-md-8">
                                                        ...
                                                        <textarea 
                                                            ...
                                                            placeholder="Enter Medicine remarks">{{ isset($gpe_data->remarks) ? trim($gpe_data->remarks) : '' }}{{ old('kt_docs_repeater_advanced_complaints.0.remarks') }}</textarea>
                                ...
                                @else
                                    <div data-repeater-item>
                                        <div class="mb-5 form-group row repeater-row-gpe">
                                            <div class="col-md-3">
                                                <label class="form-label">General Physical Examination <span
                                                        class="text-danger">*</span></label>
                                                <select class="form-select selectGPE" name="selectGPE"
                                                    data-kt-repeater="gpe_select_2" data-placeholder="Select GPE">
                                                    <option></option>
                                                    @isset($general_physical_examinations)
                                                        @foreach ($general_physical_examinations as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ old('kt_docs_repeater_advanced_gpe.*.selectGPE') == $item->id ? 'selected' : '' }}>
                                                                {{ $item->name }}</option>
                                                        @endforeach
                                                    @endisset
                                                </select>
                                                @error('kt_docs_repeater_advanced_gpe.*.selectGPE')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label">Additional GPEs <span
                                                        class="text-danger">*</span></label>
                                                <select class="form-select selectSubGPE" name="selectSubGPE"
                                                    data-kt-repeater="sub_gpe_select_2" multiple
                                                    data-placeholder="Select addtional GPEs">
