                    ...
                    <div class="p-10 rorder-0 ounded b d-flex flex-column flex-md-row">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade
                                ...
                                @include('modules.clinical_diagnosis.detail.modern.complaints_tab')
                            </div>
                            ...
                            <div class="tab-pane fade
                                ...
                                @include('modules.clinical_diagnosis.detail.modern.vitals_tab')
                            </div>

                            <div class="tab-pane fade" id="kt_vtab_pane_6" role="tabpanel">
                                @include('modules.clinical_diagnosis.detail.modern.brief_history')
                            </div>

                            <div class="tab-pane fade" id="kt_vtab_pane_7" role="tabpanel">
                                @include('modules.clinical_diagnosis.detail.modern.gpe_tab')
                            </div>

                            <div class="tab-pane fade" id="kt_vtab_pane_8" role="tabpanel">
                                @include('modules.clinical_diagnosis.detail.modern.spe_tab')
                            </div>

                            <div class="tab-pane fade" id="kt_vtab_pane_9" role="tabpanel">
                                @include('modules.clinical_diagnosis.detail.modern.investigations_tab')
                            </div>

                            <div class="tab-pane fade" id="kt_vtab_pane_10" role="tabpanel">
                                @include('modules.clinical_diagnosis.detail.modern.diagnosis_tab')
                            </div>

                            <div class="tab-pane fade" id="kt_vtab_pane_14" role="tabpanel">
                                @include('modules.clinical_diagnosis.detail.modern.procedure_tab')
                            </div>

                            <div class="tab-pane fade" id="kt_vtab_pane_11" role="tabpanel">
                                @include('modules.clinical_diagnosis.detail.modern.treatment_tab')
                            </div>

                            <div class="tab-pane fade" id="kt_vtab_pane_12" role="tabpanel">
                                @include('modules.clinical_diagnosis.detail.modern.disposal_tab')
                            </div>
