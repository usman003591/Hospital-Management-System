...
<style>
    ...
    .selectMedicine+.select2-container .select2-selection__choice.is-in-house,
    .selectMedicine+.select2-container .select2-selection__rendered.is-in-house {
        background-color: #d4edda !important;
        color: #155724 !important;
    }
</style>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="mb-5 card card-xl-stretch mb-xl-8">
                <!-- DEBUG: layout selected -->
{{-- <p style="color:red;">Layout selected: {{ $layout }}</p> --}}

                @if ($layout == 'opd_simple_layout')
                    @include('modules.clinical_diagnosis.detail.partials.opd_simple_layout')
                @elseif ($layout == 'opd_advanced_layout')
                    @include('modules.clinical_diagnosis.detail.partials.opd_advanced_layout')
                @else
                    @include('modules.clinical_diagnosis.detail.partials.opd_modern_layout')
                @endif
...
{{-- @include('modules.clinical_diagnosis.detail.scripts.opd_modern_scripts'); --}}
{{-- @include('modules.clinical_diagnosis.detail.scripts.opd_simple_scripts'); --}}

@if ($layout == 'opd_simple_layout')
@include('modules.clinical_diagnosis.detail.scripts.opd_simple_scripts')
@elseif ($layout == 'opd_advanced_layout')
@include('modules.clinical_diagnosis.detail.scripts.opd_advanced_scripts')
@else
@include('modules.clinical_diagnosis.detail.scripts.opd_modern_scripts')
@endif
@endsection
