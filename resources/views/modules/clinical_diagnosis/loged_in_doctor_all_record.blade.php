...
'clinical_diagnosis_my_all', 'activeThirdMenu' => 'clinical_diagnosis_my_all'])
@section('breadcrumbs')
...
<div class="container">
    <div class="row">
           <div class="col-md-12" id="dataResultDivLiveWire" >
            @include('include.messages')
            <livewire:clinical-diagnosis.opd.doctors-all-listing>
           </div>
    </div>
</div>
