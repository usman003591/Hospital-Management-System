...
'clinical_diagnosis_my_daily', 'activeThirdMenu'
...
<div class="container">
    <div class="row">
           <div class="col-md-12" id="dataResultDivLiveWire" wire:poll.10s>
            @include('include.messages')
            <livewire:clinical-diagnosis.opd.doctors-daily-listing>
           </div>
    </div>
</div>
