...
@extends('layouts.master', ['activeMenu' => 'pharmacy_management', 'activeSubMenu' => 'cashiers', 'activeThirdMenu' => 'cashiers'])
@section('breadcrumbs')
            ...
            <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
                ...
                <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                    ...
                    <a href="{{ route('cashiers.index') }}">
                        <li class="breadcrumb-item text-muted text-hover-primary">Pharmacy Cashiers</li>
                    </a>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
    ...
    <div class="row">
        <div class="col-md-12">
            @include('include.messages')
                <livewire:cashiers.all-cashiers-listing />
        </div>
    </div>
</div>
