...
@extends('layouts.master', ['activeMenu' => 'settings_management', 'activeSubMenu' => 'brands', 'activeThirdMenu' => 'brands'])
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <livewire:brands.all-brands-listing />
            </div>
        </div>
    </div>

    @include('modules.brands.modals.delete')
@endsection
