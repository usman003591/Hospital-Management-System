...
@extends('layouts.master', ['activeMenu' => 'pharmacy_management', 'activeSubMenu' => 'medicine_inventory_statuses', 'activeThirdMenu' => 'medicine_inventory_statuses'])
@section('breadcrumbs')
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
            ...
            <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
                ...
                <h1 class="my-0 text-gray-900 page-heading d-flex fw-bold fs-3 flex-column justify-content-center">
                    Medicine Inventory Status List
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                ...
                @if(checkPersonPermission('create_medicine_inventory_status_45'))
                    <a href="{{ route($page . '.create') }}">
                        <button type="button" class="btn btn-sm btn-light-primary" data-bs-toggle="modal"
                            ...
                            </i>Add Medicine Inventory Status
                        </button>
                    </a>
                @endif
            </div>
    ...
    <div class="row">
        <div class="col-md-12">
            @include('include.messages')
                <livewire:medicine_inventory_statuses.all-medicine-inventory-statuses-listing />
        </div>
    </div>
</div>
