...
@extends('layouts.master', ['activeMenu' => 'settings_management', 'activeSubMenu' => 'investigation_custom_fields', 'activeThirdMenu' => 'investigation_custom_fields'])
                ...
                @if(checkPersonPermission('create_investigations_custom_fields_59'))
                    <a href="{{ route($page . '.create') }}">
                        <button type="button" class="btn btn-sm btn-light-primary" data-bs-toggle="modal"
                            ...
                            </i>Add Investigation Custom Fields
                        </button>
                    </a>
                @endif
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <livewire:investigation-custom-fields.all-investigation-custom-fields-listing />
            </div>
        </div>
    </div>
