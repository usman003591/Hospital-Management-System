    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <h1 class="my-0 text-gray-900 page-heading d-flex fw-bold fs-3 flex-column justify-content-center">
                Update Investigation Custom Fields</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="{{route('investigation_custom_fields.edit', $obj->id)}}">
                    <span></span>
...
<div class="col-xl-12">
    ...
    <div class="mb-5 card card-xl-stretch mb-xl-8">
        ...
        <form class="form" action="{{route($page.'.update',$obj->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <h3 class="mb-6 font-size-lg text-dark font-weight-bold">1. Investigation Custom Fields Info </h3>
                <div class="mb-15">

                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Investigation Custom Field Name <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{$obj->name}}"
                            {{-- pattern="[A-Za-z\s.]+" --}}
                                name="name" class="form-control" placeholder="Enter investigation custom field name" {{--
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Unit <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ $obj->unit }}"
                                name="unit" class="form-control" maxlength="20"
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Male Reference Min <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ $obj->male_reference_min }}"
                                name="male_reference_min" class="form-control" maxlength="50"
                                placeholder="Enter male reference min" />
                            {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                            <div>
                                @error('male_reference_min')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Male Reference Max <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ $obj->male_reference_max }}"
                                name="male_reference_max" class="form-control" maxlength="50"
                                placeholder="Enter male reference max" />
                            {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                            <div>
                                @error('male_reference_max')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Female Reference Min <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ $obj->female_reference_min }}"
                                name="female_reference_min" class="form-control" maxlength="50"
                                placeholder="Enter female reference min" />
                            {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                            <div>
                                @error('female_reference_min')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Female Reference Max <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ $obj->female_reference_max }}"
                                name="female_reference_max" class="form-control" maxlength="50"
                                placeholder="Enter female reference max" />
                            {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                            <div>
                                @error('female_reference_max')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">All Reference Min <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ $obj->all_reference_min }}"
                                name="all_reference_min" class="form-control" maxlength="50"
                                placeholder="Enter all reference min" />
                            {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                            <div>
                                @error('all_reference_min')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">All Reference Max <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ $obj->all_reference_max }}"
                                name="all_reference_max" class="form-control" maxlength="50"
                                placeholder="Enter all reference max" />
                            {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                            <div>
                                @error('all_reference_max')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">reference notes</label>
                        <div class="col-lg-6">
                            <textarea  name="reference_notes" class="form-control" value="{{ old('reference_notes') }}"
                                placeholder="Enter all reference notes" rows="3" cols="20" >@isset($obj->reference_notes){{ $obj->reference_notes }}@endisset</textarea>
                            {{-- <span class="form-text text-muted">We'll never share your phone with anyone else</span>
                            --}}
                            <div>
                                @error('reference_notes')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
