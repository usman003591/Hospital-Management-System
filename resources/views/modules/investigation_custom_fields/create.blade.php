    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <h1 class="my-0 text-gray-900 page-heading d-flex fw-bold fs-3 flex-column justify-content-center">
                Create Investigation Custom Field</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="{{route('investigation_custom_fields.create')}}">
                    <span></span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" value="{{ old('name') }}" {{--
                                ...
                                placeholder="Enter investigation custom field name" />
                            <div>
                                @error('name')
...
<br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="unit" class="form-control" value="{{ old('unit') }}"
                                placeholder="Enter unit" maxlength="20"/>
                            <div>
                                @error('unit')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Male Reference Min <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ old('male_reference_min') }}"
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Male Reference Max <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" name="male_reference_max" class="form-control" value="{{ old('male_reference_max') }}"
                                placeholder="Enter male reference max" maxlength="200" />
                            <div>
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Female Reference Min <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ old('female_reference_min') }}"
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Female Reference Max <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" name="female_reference_max" class="form-control" value="{{ old('female_reference_max') }}"
                                placeholder="Enter female reference max" maxlength="200" />
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">All Reference Min <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ old('all_reference_min') }}"
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">All Reference Max <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" name="all_reference_max" class="form-control" value="{{ old('all_reference_max') }}"
                                placeholder="Enter all reference max" maxlength="200" />
                            {{-- <span class="form-text text-muted">We'll never share your phone with anyone else</span>
                            --}}
                            <div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea  name="reference_notes" class="form-control" value="{{ old('reference_notes') }}"
                                placeholder="Enter all reference notes" rows="3" cols="20" ></textarea>
                            {{-- <span class="form-text text-muted">We'll never share your phone with anyone else</span>
                            --}}
                            <div>
