    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="{{route('invoices.edit', $obj->id)}}">
                    <span></span>
        ...
        <form class="form" action="{{route($page.'.update',$obj->id)}}" method="POST" enctype="multipart/form-data" target="_blank">
            ...
            <div class="card-body">
                ...
                <div class="mb-15">
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Services <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <select class="form-control select2 form-select" id="kt_select2_3" name="services[]"
                                ...
                                <optgroup label="{{ $service->service_name }}">
                                    ...
                                    @if($child->id == $sc->service_category_id) selected @endif
                                    @endforeach>

                                    {{$child->service_name}} - {{$child->category_code}}
                                   </option>
                                   @endforeach
                                </optgroup>
                                @endforeach
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            {{-- <select class="form-control form-select" name="discount_amount" data-live-search="true"
                                id="kt_select2_1">
