...
'activeMenu' => 'invoices_management',
'activeSubMenu' => $page,
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <li class="breadcrumb-item text-muted text-hover-primary">
                    <a href="{{ route('invoices.index') }}" class="text-muted text-hover-primary">
                        {{ titleFilter($page) }}
                    </a>
                </li>
            </ul>
...
<livewire:invoices.all-invoices-listing />
@else
<livewire:invoices.invoices-listing />
@endif
