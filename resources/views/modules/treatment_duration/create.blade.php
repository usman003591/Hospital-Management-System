    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <a href="{{route('treatment_duration.index')}}">
                    <span></span>
                    <li class="breadcrumb-item text-muted text-hover-primary">Medication Frequency</li>
                </a>
                <!--end::Item-->
                ...
                <a href="{{route('treatment_duration.create')}}">
                    <span></span>
            ...
            <div class="card-body">
                ...
                <div class="mb-15">
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Medication Frequency Name <span
                    ...
                    <br>
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Medication Dosage Urdu Name <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" value="{{ old('name_ur') }}" name="name_ur" class="form-control"
                                maxlength="50" placeholder="علاج کی خوراک کا نام درج کریں" style="direction: rtl" />
                            <div>
                                @error('name_ur')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
