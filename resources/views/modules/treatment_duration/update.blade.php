    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="{{route('treatment_duration.edit', $obj->id)}}">
                    <span></span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="name" class="form-control"
                                placeholder="Enter medication frequency name" value="{{$obj->name}}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="name_ur" class="form-control"
                                placeholder="علاج کی خوراک کا نام درج کریں" value="{{$obj->name_ur}}"
                                oninput="this.value = this.value.replace(/[^a-zA-Z\s.{0-9}]/g, ''); capitalizeWords(this)"
                                style="direction: rtl" />
                            {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                            <div>
