                        ...
                        <thead class="text-gray-500 fs-7 text-uppercase">
                            <tr role="row" class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                <th class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom"
                                    ...
                                    tabindex="0" style="min-width: 10rem"><span class="dt-column-title">Name
                                ...
                                <th class="dt-type-numeric dt-orderable-asc dt-orderable-desc" data-dt-column="2"
                                    ...
                                    style="min-width: 8rem"><span class="dt-column-title" role="button">Unit</span><span
                                ...
                                <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="3" rowspan="1"
                                    ...
                                    style="min-width: 8rem"><span class="dt-column-title">Is Boolean</span><span
                                        class="dt-column-order"></span></th>
                                ...
                                <th class="dt-orderable-asc dt-orderable-desc" data-dt-column="3" rowspan="1"
                                    colspan="1" aria-label="Status: Activate to sort" tabindex="0"
                                    style="min-width: 6rem"><span class="dt-column-title">Status</span><span
                                        class="dt-column-order"></span></th>
                            ...
                            <tr class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                ...
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Info-->
                                        <div class="d-flex flex-column justify-content-center">
                                            <a href="" class="mb-1 text-gray-800 text-hover-primary">@isset($d->unit)
                                                {{$d->unit}}
                                                @endisset </a>
                                        </div>
                                        <!--end::Info-->
                                ...
                                <td>
                                    @if($d->is_boolean == 1)
                                    <span class="mr-2  font-weight-lighter">yes</span>
                                    @else
                                    <span class="mr-2 font-weight-lighter">No</span>
                                    @endif
                                    <!--begin::User-->
                                    {{-- <div class="d-flex align-items-center">
                                        <!--begin::Wrapper-->
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <a href=""
                                                class="mb-1 text-gray-800 text-hover-primary">@isset($d->is_boolean)
                                                {{$d->is_boolean}}
                                                @endisset </a>
                                        </div>
                                        <!--end::Info-->
