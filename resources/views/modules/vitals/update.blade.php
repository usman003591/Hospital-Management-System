    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="{{route('vitals.edit', $obj->id)}}">
                    <span></span>
            ...
            <div class="card-body">
                ...
                <div class="mb-15">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="name" class="form-control" placeholder="Enter vital name"
                                value="{{$obj->name}}"
                    ...
                    <br>
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Unit<span class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" name="unit" class="form-control" id="unit" value="{{ $obj->unit }}"
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Is Boolean <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <select class="form-control form-select" name="is_boolean" data-live-search="true"
                                id="deviceSelect">

                                <option value="1" @if($obj->is_boolean==1) selected @endif > Yes </option>
                                <option value="0" @if($obj->is_boolean==0) selected @endif > No
                                </option>
