...
<div class="col-xl-12">
    <div class="mb-5 card card-xl-stretch mb-xl-8">
        <form class="form" action="{{route('pharmacy.store_pharmacy_inventory')}}" method="POST"
            ...
            <div class="card-body">
                ...
                <div class="mb-15">
                            ...
                            <label class="text-right col-lg-3 col-form-label">Hospital </label>
                            <div class="col-lg-6">
                                <label
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Medicine<span
                              ...
                              <div class="col-lg-6">
                                <select class="form-control form-select" name="medicine_id" data-live-search="true" required
                                    id="medicineSelect">
                   ...
                   <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Inventory Status<span
                                class="text-danger">*</span></label>
                              <div class="col-lg-6">
                                <select class="form-control form-select" name="medicine_inventory_status_id" data-live-search="true" required
                                    id="medicineSelect">
                    ...
                    <label class="text-right col-lg-3 col-form-label">Reorder Number<span
                                class="text-danger">*</span></label>
                    <div class="col-lg-6">
                        <input type="number" name="reorder_number"  placeholder="Enter Medicine Reorder Number" class="form-control" id="reorder_number" oninput="this.value = this.value.replace(/\D/g, '').substring(0, 9)" required
                        value="{{old('reorder_number')}}">
