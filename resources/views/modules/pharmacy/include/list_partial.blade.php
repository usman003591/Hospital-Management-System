                    ...
                    <table id="kt_project_users_table"
                        ...
                        <tbody class="fs-6">
                            ...
                            <tr class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                ...
                                <td>@isset($d->created_at) {{getDateInStandardFormat ($d->created_at)}} @endif </td>
                                ...
                                <td class="align-middle text-end">
                                    <div class="d-flex justify-content-center align-items-center">
                                        @if(checkPersonPermission('detail_patient_medicines_42'))
                                        <a title="View Medicine Details"
                                            data-id="{{$d->id}}"
                                            class="btn btn-icon btn-active-light-primary w-30px h-30px medicine-details-instance"
