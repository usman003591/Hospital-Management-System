        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="{{route('systematic_physical_examinations.index')}}">
                    <span></span>
                    <li class="breadcrumb-item text-muted text-hover-primary">Systematic Physical Examinations</li>
                </a>
                <!--end::Item-->
                ...
                <a href="{{route('systematic_physical_examinations.create')}}">
                    <span></span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="name" class="form-control" value="{{ old('name') }}"
                                placeholder="Enter systematic physical examination name"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="mb-2 form-control mb-md-0 selectComplaint" name="parent_id"
                                data-live-search="true" id="symptomSelect" placeholder="Select Parent">
