                ...
                <div class="mb-15">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="name" class="form-control"
                                value="{{ old('name') }}" placeholder="Enter Procedure name"
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Department <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <select class="mb-2 form-control mb-md-0 selectDepartment" name="department_id"
                                data-live-search="true" id="selectDepartment" placeholder="Select Department"
