...
<div class="mb-5 form-group row bg-search">
    ...
    <div class="col-lg-3">
        <select id="status" class="form-select ajax_call_trigger form-select-solid bg-body-secondary"
            data-kt-select2="true" data-placeholder="Select Status" data-allow-clear="false" data-hide-search="true">
            <option selected disabled> {{ __('Select Status')}}</option>
            <option {{!isset($search['status']) || $search['status']==2 }} value="2">All Statuses</option>
