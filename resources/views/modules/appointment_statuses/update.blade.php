        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <a href="{{route('appointment_statuses.index')}}">
                    <span></span>
                    <li class="breadcrumb-item text-muted text-hover-primary">Appointment Status</li>
                </a>
                <!--end::Item-->
                ...
                <a href="{{route('appointment_statuses.edit', $status->id)}}">
                    <span></span>
...
<div class="col-xl-12">
    ...
    <div class="mb-5 card card-xl-stretch mb-xl-8">
        ...
        <!--end::Header-->
        <!--begin::Body-->
        <form class="form" action="{{route($page.'.update',$status->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('patch')
            ...
            <div class="card-body">
                ...
                <div class="mb-15">
                    ...
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Appointment Status Name <span
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control form-select" name="status" data-live-search="true"
                                ...
                                <option value="0" @if($status->status==0) selected @endif > Inactive </option>
                            </select>
                            <div>
                                @error('status')
                                <small class="text-danger">{{ $message }}</small>
