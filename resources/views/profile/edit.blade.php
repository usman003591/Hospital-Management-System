...
<div id="kt_app_toolbar" class="py-3 app-toolbar py-lg-6" data-select2-id="select2-data-kt_app_toolbar">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            <!--begin::Title-->
            <h1 class="my-0 text-gray-900 page-heading d-flex fw-bold fs-3 flex-column justify-content-center">User
                Profile</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
                ...
                <div class="flex-wrap mb-2 d-flex justify-content-between align-items-start">
                    ...
                    {{-- <div class="d-flex flex-column"> --}}
                        ...
                        <div class="mb-2 d-flex flex-column">
                            <a href="#" class="pb-2 text-gray-900 text-hover-primary fs-2 fw-bold">@isset($user)
                                {{$user->name}}
                                @endisset</a>
                            <p class="fw-semibold fs-6">
                                @auth
                                <span>{{ auth()->user()->role ? auth()->user()->role->name :
                                    'N/A'}}</span>
                                @endauth
                            </p>
                            {{-- <a href="#">
        ...
        <ul class="border-transparent nav nav-stretch nav-line-tabs nav-line-tabs-2x fs-5 fw-bold">
            ...
            <li class="mt-2 nav-item">
                ...
                <a class="py-5 nav-link text-active-primary ms-0 me-10 active"
                    href="{{route('profile.edit')}}">Overview</a>
                    @endif
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
...
<div class="mb-5 card mb-xl-10" id="kt_profile_details_view">
    ...
    <div class="card-body p-9">
        ...
        <div class="row mb-7">
            ...
            <!--begin::Col-->
            <div class="col-lg-8">
                <span class="text-gray-800 fw-bold fs-6">@isset($user)
                    {{$user->name}}
                    @endisset</span>
            </div>
            <!--end::Col-->
        ...
        <div class="row mb-7">
            ...
            <div class="col-lg-8 fv-row">
                <span class="text-gray-800 fw-semibold fs-6">@isset($user)
                    {{$user->email}}
                    @endisset</span>
            </div>
            <!--end::Col-->
        ...
        <div class="row mb-7">
            ...
            <div class="col-lg-8 d-flex align-items-center">
                <span class="text-gray-800 fw-bold fs-6 me-2">@isset($user)
                    {{$user->phone}}
                    @endisset</span>
            </div>
            <!--end::Col-->
        ...
        {{-- <div class="p-6 border border-dashed rounded notice d-flex bg-light-warning border-warning">
            ...
            <div class="d-flex flex-stack flex-grow-1">
                ...
                <div class="fw-semibold">
                    ...
                    <div class="text-gray-700 fs-6">Your payment was declined. To start using tools, please
