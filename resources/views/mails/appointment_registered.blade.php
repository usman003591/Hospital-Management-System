...
<body>
    <div class="container">
        <div class="header">Appointment Registered Successfully</div>
        <div class="content">
            <p>Dear <strong>{{ $data['patient_name'] }}</strong>,</p>
            <p>We are pleased to inform you that your appointment has been successfully registered to <strong>Smart City Hospitals</strong>.</p>
