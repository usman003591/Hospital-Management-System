...
class DailyInvoicesExport implements FromCollection,WithHeadings, WithStrictNullComparison
{
    /**
    ...
    */
    public function collection()
    {
        ...
        //sirm parent ids = [1,7,32,41,48,57,63,74,80]
        ...
        ->where('invoices.created_at', 'like', $today)
        ->get();
